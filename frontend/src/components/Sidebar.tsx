...
const Sidebar = () => {
  return (
    ...
    <div className="w-full bg-gradient-to-b from-black-200/40 to-white-400/40 backdrop-blur-lg border-r border-white/10 flex flex-col items-center py-8 gap-8 h-full">
